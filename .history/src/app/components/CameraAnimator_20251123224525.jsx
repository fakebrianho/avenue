...
export function CameraAnimator({
	...
	// Memoize the completion handler to avoid recreating it
	...
	// Memoize target position array to avoid unnecessary re-renders
	...
	useEffect(() => {
		...
		animationRef.current = gsap.to(camera.position, {
			x: memoizedTargetPosition[0],
			y: memoizedTargetPosition[1],
			z: memoizedTargetPosition[2],
			duration,
			ease,
