...
const OutlinedPointMaterial = shaderMaterial(
  ...
  `
    ...
    void main() {
      ...
      // Core: white circle (1.0 at center, 0.0 at coreRadius)
      float core = 1.0 - smoothstep(0.0, coreRadius, d);
      
      // Outline: pink ring (visible between outlineInner and outlineOuter)
      float outline = step(outlineInner, d) * (1.0 - step(outlineOuter, d));
      
      // If we're in the core, use white; if in outline, use pink
      vec3 col = core > 0.01 ? uColor : (outline > 0.01 ? uOutlineColor : vec3(0.0));
